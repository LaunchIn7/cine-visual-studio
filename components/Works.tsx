      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className={`text-center mb-16 transition-all duration-1000 ${
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-black text-white mb-6 leading-tight">
            Our <span className="bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-clip-text text-transparent">Work</span>
          </h2>
          
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            A showcase of our finest moments captured through the lens of creativity and passion.
          </p>
        </div>
        ...
        >
          <div className="relative max-w-4xl max-h-full">
            ...
            width={1000}
              src={selectedImage}
              alt="Full size work"
              className="max-w-full max-h-full w-80 object-contain rounded-2xl shadow-2xl"
            />
